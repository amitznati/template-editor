    ...
    if (double) {
      ...
      return [
        <CoreNumber
          ...
          onChange={(v) =>
            onAttributeChange({ name, value: `${v} ${values[1]}` })
          }
          disabled={disabled}
        />,
        <CoreNumber
          ...
          inputProps={{ min, max, step }}
          onChange={(v) =>
            onAttributeChange({ name, value: `${values[0]} ${v}` })
          }
          disabled={disabled}
        />
      ];
